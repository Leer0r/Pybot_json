...
class JSON_MASTER():
    ...
    def cible(self):
        ...
        self.current_familyname = input("Quel est le nom de la personne a définir comme reperoire courrant ? : ").lower()
        self.current_name = input("Quel est le prenom de la personne a définir comme reperoire courrant ? : ").lower()
...
class MAIN(JSON_MASTER):
    ...
    def decision(self,str_decision):
        if str_decision == "ajoute une nouvelle personne":
            ...
            return
        if str_decision == "supprime cette personne":
            self.supprimer_personne()
            return
        if str_decision == "cible une personne":
            self.cible()
        else:
